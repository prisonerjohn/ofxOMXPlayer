...
#define DVD_TIME_TO_SEC(x)  ((int)((double)(x) / AV_TIME_BASE))
#define DVD_TIME_TO_MSEC(x) ((int)((double)(x) * 1000 / AV_TIME_BASE))
#define DVD_SEC_TO_TIME(x)  ((double)(x) * AV_TIME_BASE)
#define DVD_MSEC_TO_TIME(x) ((double)(x) * AV_TIME_BASE / 1000)
